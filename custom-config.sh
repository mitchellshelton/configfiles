...
# Special shades for handling mismatched colors
ORANGE_BG_FOR_TEXT="#293556"
ORANGE_BG_FOR_ICON="#324067"
BLUE_BG_FOR_TEXT="#2B99EE"
BLUE_BG_FOR_ICON="#1D7CC9"

# USER BLOCK
USER_LEFT_ICON="%F{${BLUE_BG_FOR_ICON}}"
USER_TEXT="%K{${BLUE_BG_FOR_TEXT}}%F{${TEXT_COLOR}} %B%n %b"
USER_RIGHT_ICON="%K{${DIR_BG_COLOR}}%F{${BLUE_BG_FOR_ICON}}%f%k"
PROMPT_USER="${USER_LEFT_ICON}${USER_TEXT}${USER_RIGHT_ICON}"

# DIRECTORY BLOCK
DIR_TEXT="%K{${DIR_BG_COLOR}}%F{${DIR_TEXT_COLOR}} %1~ "
DIR_RIGHT_ICON="%K{${ORANGE_BG_FOR_ICON}}%F{${DIR_BG_COLOR}}%f%k"
PROMPT_DIR="${DIR_TEXT}${DIR_RIGHT_ICON}"

# TIME BLOCK
TIME_FORMAT="%D{%I:%M %p}"
TIME_TEXT="%K{${ORANGE_BG_FOR_ICON}}%F{${TIME_TEXT_COLOR}} ${TIME_FORMAT} "
TIME_RIGHT_ICON="%f%k%F{${ORANGE_BG_FOR_TEXT}}%f%k"
